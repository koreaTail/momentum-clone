...
function clockHandler() {
    if (new Date().getHours() < 10 && new Date().getMinutes() < 10) {
        현재시간.innerHTML = `0${new Date().getHours()}:0${new Date().getMinutes()}`
    } else if (new Date().getHours() < 10) {
        현재시간.innerHTML = `0${new Date().getHours()}:${new Date().getMinutes()}`
    } else if (new Date().getMinutes() < 10) {
        현재시간.innerHTML = `${new Date().getHours()}:0${new Date().getMinutes()}`
    } else {
